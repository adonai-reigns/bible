\documentclass[twopage,twocolumn,showtrims,9pt]{memoir}
...
\newcommand{\customsection}[2][]{%
  \ifthenelse{\isempty{#1}}%
    ...
    {\addcontentsline{toc}{section}{\headings{#2}}\section*{#2}}
    % permit an override value to be used in TOC
    {\addcontentsline{toc}{section}{\headings{#1}}\section*{#2}}
}
\newcommand{\biblebook}[2][]{%
  \setcounter{biblechapter}{0}
  \ifthenelse{\isempty{#1}}%
    % use the section title name for the TOC contents line
    {\addcontentsline{toc}{chapter}{\headings{#2}}\gdef\currbook{#2}\chapter*{#2}}
    % permit an override value to be used in TOC
    {\addcontentsline{toc}{chapter}{\headings{#1}}\gdef\currbook{#2}\chapter*{#2}}
}
