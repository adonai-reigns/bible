...
\newenvironment{biblechapter}[1][\thebiblechapter]
  ...
  \setbeforesecskip{9pt}\setbeforesubsecskip{9pt}
...
\setlrmarginsandblock{0.5in}{0.375in}{*}
...
\setlrmarginsandblock{0.5in}{0.3125in}{*}
\checkandfixthelayout 
...
\fancyhfoffset[RO,LE]{0.375pt}

\setlength\textwidth{5.1875in\relax}
\setlength\columnwidth{2.4625in\relax}
\setlength\columnsep{0.2625in\relax}
