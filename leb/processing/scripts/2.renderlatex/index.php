...
// we need to map the shorthand booknames that are used in the SQLDB, to correspond to our system book names
...
while(strstr($sourceXML, '  ') !== false){
    $sourceXML = str_replace('  ', ' ', $sourceXML);
}
