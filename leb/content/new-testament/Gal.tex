...
\verseWithHeading{Paul’s Defense of His Apostleship}{For I make known to you, brothers, the gospel that has been proclaimed by me, that it is not of human origin\lebnote{“according to man”}.}%
...
\verse{and was progressing in Judaism beyond many contemporaries in my nation, because\lebnote{“\textit{because}” is supplied as a component of the participle (“was”) which is understood as causal} I was a far more zealous adherent of the traditions handed down by my forefathers.}%
...
\verse{but I was unknown in person\lebnote{“by face”} to the churches of Judea that are in Christ,}%
...
\verse{But not even Titus who was with me, although\lebnote{“\textit{although}” is supplied as a component of the participle (“was”) which is understood as concessive} he was a Greek, was compelled to be circumcised.}%
...
\verse{But from those who were influential\lebnote{“who were thought to be something”} (whatever they were, it makes no difference to me, God does not show partiality\lebnote{“God does not receive the face of man”}) — for those who were influential added nothing to me.}%
\verse{But these, when they\lebnote{“\textit{when}” is supplied as a component of the participle (“saw”) which is understood as temporal} saw that I had been entrusted with the gospel to the uncircumcision, just as Peter to the circumcision}%
...
\verse{For before certain people came from James, he used to eat with the Gentiles, but when they came, he withdrew and separated himself, because he\lebnote{“\textit{because}” is supplied as a component of the participle (“was afraid of”) which is understood as causal} was afraid of those who were of the circumcision,}%
...
\verse{then understand that the ones who have faith\lebnote{“of faith”}, these are sons of Abraham.}%
\verse{And the scripture, foreseeing that God would justify the Gentiles by faith, proclaimed the good news in advance to Abraham: “In you all the nations\lebnote{Or “Gentiles”; the same Greek word can be translated “nations” or “Gentiles” depending on the context} will be blessed.”\lebnote{from Gen 12:3; 18:18}}%
\verse{So then, the ones who have faith are blessed together with Abraham who believed.}%
\verse{For as many as are of the works of the law are under a curse, for it is written, “Cursed is everyone who does not abide by all the things that are written in the book of the law to do them.”\lebnote{from Deut 27:26}}%
...
\verse{But the law is not from faith, but “the one who does these things will live by them.”\lebnote{from Lev 18:5}}%
\verse{Christ redeemed us from the curse of the law by\lebnote{“\textit{by}” is supplied as a component of the participle (“becoming”) which is understood as means} becoming a curse for us, because it is written, “Cursed is everyone who hangs on a tree,”\lebnote{from Deut 21:23}}%
...
\verseWithHeading{The Promise to Abraham and His Descendant}{Brothers, I am speaking according to a human perspective. Nevertheless, when\lebnote{“\textit{when}” is supplied as a component of the participle (“has been ratified”) which is understood as temporal} the covenant of a man has been ratified, no one declares it invalid or adds additional provisions to it.}%
\verse{Now to Abraham and to his descendant the promises were spoken. It does not say, “and to descendants,” as concerning many, but as concerning one, “and to your descendant,”\lebnote{from Gen 12:7; 13:15; 17:7; 24:7} who is Christ.}%
...
\verse{But the scripture imprisoned all under sin, in order that the promise could be given by faith\lebnote{Or “through the faithfulness of Jesus Christ”} in Jesus Christ to those who believe.}%
...
\verse{But after\lebnote{“\textit{after}” is supplied as a component of the participle (“has come”) which is understood as temporal} faith has come, we are no longer under a guardian.}%
...
\verseWithHeading{No Longer Slaves But Sons and Heirs}{Now I say, for as long a time as the heir is a child, he is no different from a slave, although he\lebnote{“\textit{although}” is supplied as a component of the participle (“is”) which is understood as concessive} is master of everything,}%
\verse{but he is under guardians and managers until the time set by his father.}%
\verse{So also we, when we were children, we were enslaved under the principles of the world.}%
...
\verseWithHeading{Do Not Be Enslaved Again}{But at that time when you\lebnote{“\textit{when}” is supplied as a component of the participle (“know”) which is understood as temporal} did not know God, you were enslaved to the things which by nature are not gods.}%
\verse{But now, because you have come to know God, or rather have come to be known by God, how can you turn back again to the weak and miserable principles? Do you want to be enslaved to them\lebnote{“to whom”} all over again?}%
...
\verse{So then, have I become your enemy by\lebnote{“\textit{by}” is supplied as a component of the participle (“being truthful”) which is understood as means} being truthful to you?}%
...
\verseWithHeading{Hagar and Sarah Represent Two Covenants}{Tell me, you who are wanting to be under the law, do you not understand\lebnote{“hear”} the law?}%
...
\verse{For it is written, “Rejoice, O barren woman, who does not give birth to children; burst out and shout, you who do not have birth pains, because many are the children of the desolate woman, even more than those of the one who has a husband.”\lebnote{from Isa 54:1}}%
...
\verse{But what does the scripture say? “Drive out the female slave and her son, for the son of the female slave will never inherit with the son”\lebnote{from Gen 21:10, which does not include the words “of the free woman”} of the free woman.}%
...
\verse{You are estranged from Christ, you who are attempting to be justified\lebnote{The present tense has been translated as conative here (“are attempting”)} by the law; you have fallen from grace.}%
...
\verse{I have confidence in you in the Lord that you will think nothing different, but the one who is confusing you will pay the penalty\lebnote{“will bear the \textit{= his} condemnation”}, whoever he may be.}%
...
\verse{I wish that the ones who are disturbing you would also castrate themselves\lebnote{“cut themselves off”}!}%
...
\verse{For the whole law is fulfilled in one statement, namely, “You shall love your neighbor as yourself.”\lebnote{from Lev 19:18}}%
...
\verse{Now those who belong to Christ\lebnote{“of Christ”}\lebnote{Some manuscripts have “Christ Jesus”} have crucified the flesh together with its feelings and its desires.}%
...
\verse{For if anyone thinks he is something although he\lebnote{“\textit{although}” is supplied as a component of the participle (“is”) which is understood as concessive} is nothing, he is deceiving himself.}%
...
\verse{And let us not grow weary in doing good, for at the proper time we will reap, if we\lebnote{“\textit{if}” is supplied as a component of the participle (“give up”) which is understood as conditional} do not give up.}%
...
\verse{As many as are wanting to make a good showing in the flesh, these are attempting to compel\lebnote{The present tense has been translated as conative here (“are attempting”)} you to be circumcised, only so that they will not be persecuted for the cross of Christ.}%
...
\verse{And all those who follow this rule, peace and mercy be on them and on the Israel of God\lebnote{Consider Galatians 4:24-26}.}%
