...
\verse{For certain men\lebnote{Or “people,” since the Greek term can be used in a generic sense, but if this statement is related to 2 Peter 2:1-2, it is more likely men are in view} have slipped in stealthily, who were designated long ago for this condemnation, ungodly ones, who change the grace of our God into licentiousness and who deny our only Master and Lord Jesus Christ.}%
...
\verse{as Sodom and Gomorrah and the towns around them indulged in sexual immorality and pursued unnatural desire\lebnote{“went after other flesh”} in the same way as these, are exhibited as an example by\lebnote{“\textit{by}” is supplied as a component of the participle (“undergoing”) which is understood as means} undergoing the punishment of eternal fire.}%
\verse{Despite that, in the same way also these men, because of their\lebnote{“\textit{because}” is supplied as a component of the participle (“dreams”) which is understood as causal} dreams, defile the flesh and reject authority and blaspheme majestic beings.}%
...
\verse{These people are grumblers, discontented, proceeding according to their\lebnote{Some manuscripts have “their own”} desires, and their mouths speaking pompous words, showing partiality to gain an advantage\lebnote{“respecting faces for the sake of advantage”}.}%
...
\verse{and save others by\lebnote{“\textit{by}” is supplied as a component of the participle (“snatching”) which is understood as means} snatching them from the fire, and have mercy on others with fear, hating even the tunic stained by the flesh.}%
