...
\verse{If anyone is blameless, the husband of one wife, having faithful\lebnote{Or “believing”} children, not accused of dissipation\lebnote{“with an accusation of dissipation”} or rebellious.}%
...
\verse{whom it is necessary to silence, whoever are ruining whole families by\lebnote{“\textit{by}” is supplied as a component of the participle (“teaching”) which is understood as means} teaching things which must not be taught for the sake of dishonest gain.}%
...
\verse{They profess to know God, but by their deeds they deny him, because they\lebnote{“\textit{because}” is supplied as a component of the participle (“are”) which is understood as causal} are detestable and disobedient, and unfit for every good deed.}%
\end{biblechapter}%
...
\verse{a sound message beyond reproach, in order that an opponent\lebnote{“one from \textit{the} opposed”} may be put to shame, because he\lebnote{“\textit{because}” is supplied as a component of the participle (“has”) which is understood as causal} has nothing bad to say concerning us.}%
...
\verse{Diligently send on their way Zenas the lawyer and Apollos, so that they may lack nothing\lebnote{“nothing may lack to them”}.}%
