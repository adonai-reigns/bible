...
\verse{to the church of God sanctified in Christ Jesus that is in Corinth,\lebnote{Some manuscripts have “to the church of God that is in Corinth, sanctified in Christ Jesus”} called to be saints, together with all those who call upon the name of our Lord Jesus Christ in every place, their Lord\lebnote{“Lord” must be supplied to indicate the referent; otherwise this could be understood as “their place and ours”} and ours.}%
...
\verse{that\lebnote{Or “because”; the conjunction either (1) introduces a content clause (“that”) giving the content of Paul’s thanks, or (2) introduces a causal clause (“because”) giving the reason for Paul’s thanks} in everything you were made rich in him, in all speech and all knowledge,}%
\verse{just as the testimony about Christ has been confirmed in you,}%
\verse{so that you do not lack in any spiritual gift as you\lebnote{“\textit{as}” is supplied as a component of the participle (“eagerly await”) which is understood as temporal} eagerly await the revelation of our Lord Jesus Christ,}%
...
\verse{For it has been made clear to me concerning you, my brothers, by Chloe’s people\lebnote{“those of Chloe”}, that there are quarrels among you.}%
...
\verse{Has Christ been divided? Paul was not crucified for you, was he?\lebnote{*The negative construction in Greek anticipates a negative answer here} Or were you baptized in the name of Paul?}%
...
\verse{For Christ did not send me to baptize, but to proclaim the gospel, not with clever speech\lebnote{“wisdom of word”}, lest the cross of Christ be emptied.}%
...
\verse{For it is written, “I will destroy the wisdom of the wise, and the intelligence of the intelligent I will confound.”\lebnote{from Isa 29:14}}%
...
\verse{Seeing as both Jews seek a sign and Greeks seek wisdom,}%
\verse{we, however, preach Christ crucified: to the Jews indeed a cause for stumbling and to the Gentiles foolishness,}%
\verse{but to those who are called, both Jews and Greeks, Christ is the power of God and the wisdom of God.}%
\verse{For the foolishness of God is wiser than human wisdom,\lnDKT{} and the weakness of God is stronger than human strength.\lnDKT{}}%
...
\verse{so that, just as it is written, “The one who boasts, let him boast in the Lord.”\lebnote{from Jer 9:24}}%
\end{biblechapter}%
...
\verse{But just as it is written, “Things which eye has not seen and ear has not heard, and have not entered into the heart of man, all that\lebnote{Some manuscripts have “which”} God has prepared for those who love him.”\lebnote{from Isa 64:4}}%
\verse{For\lebnote{Some manuscripts have “But to us God has revealed \textit{them}”} to us God has revealed them through the Spirit. For the Spirit searches all things, even the depths of God.}%
...
\verse{things which we also speak, not in words taught by human wisdom, but in words taught by the Spirit, explaining spiritual things to spiritual people.\lebnote{Or “in spiritual \textit{words}”}}%
...
\verse{“For who has known the mind of the Lord; who has advised him?”\lebnote{from Isa 40:13} But we have the mind of Christ.}%
\end{biblechapter}%
...
\verse{For the wisdom of this world is foolishness with God, for it is written, “The one who catches the wise in their craftiness,”\lebnote{from Job 5:13}}%
\verse{and again, “The Lord knows the thoughts of the wise, that they are futile.”\lebnote{from Ps 94:11}}%
...
\verse{For who concedes you superiority? And what do you have that you did not receive? But if indeed you received it, why do you boast as if you\lebnote{“\textit{if}” is supplied as a component of the participle (“receive”) which is understood as conditional} did not receive it?}%
\verse{Already you are satiated! Already you are rich! Apart from us you have reigned, and I wish indeed that you would reign so that also with us you might reign!}%
...
\verse{and we toil, working with our own hands. When we are\lebnote{“\textit{when}” is supplied as a component of the participle (“reviled”) which is understood as temporal} reviled, we bless; when we are\lebnote{“\textit{when}” is supplied as a component of the participle (“persecuted”) which is understood as temporal} persecuted, we endure;}%
\verse{when we are\lebnote{“\textit{when}” is supplied as a component of the participle (“slandered”) which is understood as temporal} slandered, we encourage. We have become like the refuse of the world, the offscouring of all things, until now.}%
...
\verse{For although I\lebnote{“\textit{although}” is supplied as a component of the participle (“am absent”) which is understood as concessive} am absent in body but present in spirit, I have already passed judgment on the one who has done this in this way, as if I\lebnote{“\textit{if}” is supplied as a component of the participle (“were present”) which is understood as conditional} were present.}%
\verse{In the name of our Lord Jesus, when\lebnote{“\textit{when}” is supplied as a component of the temporal genitive absolute participle (“are assembled”)} you are assembled, and my spirit, together with the power of our Lord Jesus,}%
\verse{I have decided\lebnote{The words “I have decided” are implied from the statement “I have already passed judgment” in v. 3} to hand over such a person to Satan for the destruction of the flesh, in order that his spirit may be saved in the day of the Lord.}%
...
\verse{But those outside God will judge. Remove the evil person from among yourselves\lebnote{“from you of them”}.}%
\end{biblechapter}%
\begin{biblechapter}% 1 Corinthians 6
\verseWithHeading{Lawsuits between Believers}{Does anyone among you, if he\lebnote{“\textit{if}” is supplied as a component of the participle (“has”) which is understood as conditional} has a matter against someone else, dare to go to court before the unrighteous, and not before the saints?}%
...
\verse{Or do you not know that the unrighteous will not inherit the kingdom of God? Do not be deceived! Neither sexually immoral people, nor idolaters, nor adulterers, nor effeminate, nor homosexuals,}%
\verse{nor thieves, nor greedy persons, nor drunkards, nor abusive persons, nor swindlers will inherit the kingdom of God.}%
...
\verse{Food is for the stomach, and the stomach for food, but God will abolish both of them\lebnote{“both this and these”}. Now the body is not for sexual immorality, but for the Lord, and the Lord for the body.}%
...
\verse{Or do you not know that the one who joins himself to a prostitute is one body with her? For it says, “The two will become one flesh.”\lebnote{from Gen 2:24}}%
...
\verse{Do not defraud one another, except perhaps by agreement, for a time, in order that you may devote yourselves to prayer, and then you should be together\lebnote{“at the same”} again, lest Satan tempt you because of your lack of self control.}%
...
\verse{Was anyone called after\lebnote{“\textit{after}” is supplied as a component of the participle (“being circumcised”) which is understood as temporal} being circumcised? He must not undo his circumcision. Was anyone called in uncircumcision? He must not become circumcised.}%
...
\verse{A wife is bound for as long a time as her husband lives. But if her husband dies\lebnote{“falls asleep”}, she is free to marry whomever she wishes, only in the Lord.}%
...
\verse{yet to us there is one God, the Father, from whom are all things, and we are for him, and there is one Lord, Jesus Christ, through whom are all things, and we are through him.}%
\verse{But this knowledge is not in everyone. But some, being accustomed until now to the idol, eat this food as food sacrificed to idols, and their conscience, because it\lnDKU{} is weak, is defiled.}%
...
\verse{For if someone should see you who has knowledge reclining for a meal in an idol’s temple, will not his conscience, because it\lnDKU{} is weak, be strengthened so that he eats the food sacrificed to idols?}%
\verse{For the one who is weak — the brother for whom Christ died — is destroyed by your knowledge.}%
\verse{Now if you\lebnote{“\textit{if}” is supplied as a component of the participle (“sin”) which is understood as conditional} sin in this way against the brothers and wound their conscience, which is weak, you sin against Christ.}%
\verse{Therefore, if food causes my brother to sin, I will never eat meat forever\lebnote{“for the age”}, in order that I may not cause my brother to sin.}%
\end{biblechapter}%
...
\verse{Or do only I and Barnabas not have the right to refrain from working\lebnote{“not to work”}?}%
...
\verse{For in the law of Moses it is written, “You must not muzzle an ox while it\lebnote{“\textit{while}” is supplied as a component of the participle (“threshing”) which is understood as temporal} is threshing.”\lebnote{from Deut 25:4} It is not about oxen God is concerned, is it?\lebnote{*The negative construction in Greek anticipates a negative answer here}}%
\verse{Or doubtless does he speak for our sake\lnDKV{}? For it is written for our sake\lnDKV{}, because the one who plows ought to plow in hope and the one who threshes ought to do so in hope of a share.}%
...
\verse{What then is my reward? That when I\lebnote{“\textit{when}” is supplied as a component of the participle (“proclaim the gospel”) which is understood as temporal} proclaim the gospel, I may offer the gospel free of charge, in order not to make full use of my right in the gospel.}%
\verse{For although I\lnDKW{} am free from all people, I have enslaved myself to all, in order that I may gain more.}%
\verse{I have become like a Jew to the Jews, in order that I may gain the Jews. To those under the law I became as under the law (although I\lnDKW{} myself am not under the law) in order that I may gain those under the law.}%
\verse{To those outside the law I became as outside the law (although I\lnDKW{} am not outside the law of God, but subject to the law of Christ) in order that I may gain those outside the law.}%
...
\verse{But I discipline my body and subjugate it, lest somehow after\lebnote{“\textit{after}” is supplied as a component of the participle (“preaching”) which is understood as temporal} preaching to others, I myself should become disqualified.}%
\end{biblechapter}%
...
\verse{and not become idolaters, as some of them did, just as it is written, “The people sat down to eat and drink, and stood up to play,”\lebnote{from Exod 32:6}}%
...
\verse{Or are we attempting to provoke the Lord to jealousy? We are not stronger than he is, are we?\lebnote{*The negative construction in Greek anticipates a negative answer here}}%
...
\verse{Let no one seek his own good\lebnote{“the \textit{-} of himself”; “good” is implied} but the good of the other.}%
\verse{Eat everything that is sold in the meat market, asking no questions\lnDKX{} for the sake of the conscience,}%
\verse{for “the earth is the Lord’s, and its fullness.”\lebnote{from Ps 24:1, and an allusion to Ps 50:12; 89:11}}%
\verse{If any of the unbelievers invites you, and you want to go, eat everything that is set before you, asking no questions\lnDKX{} for the sake of the conscience.}%
...
\verse{Give no offense\lebnote{“be blameless”} both to Jews and to Greeks and to the church of God,}%
...
\verse{Every man who prays or prophesies while\lebnote{“\textit{while}” is supplied as a component of the participle (“having”) which is understood as temporal} having something\lebnote{the direct object must be supplied from context, but the exact nature of the object is not clear from the context, so “\textit{something}” is used in the English translation} on his head dishonors his head,}%
...
\verse{For indeed a man ought not to cover his head, because he\lebnote{“\textit{because}” is supplied as a component of the participle (“is”) which is understood as causal} is the image and glory of God, but the woman is the glory of the man.}%
...
\verse{You judge for yourselves\lebnote{“in you yourselves”}: is it fitting for a woman to pray to God with her head\lebnote{the words “\textit{with her head}” have been supplied as a necessary clarification} uncovered?}%
...
\verse{For in the first place, when you\lnDKY{} come together as a church, I hear there are divisions among you, and in part I believe it.}%
...
\verse{Therefore, when\lnDKY{} you come together in the same place, it is not to eat the Lord’s supper.}%
\verse{For when you\lebnote{“when” is supplied as a component of the temporal infinitive (“eat”)} eat it, each one of you goes ahead to take his own supper, and one is hungry and another is drunk.}%
...
\verse{and after he\lebnote{“\textit{after}” is supplied as a component of the participle (“had given thanks”) which is understood as temporal} had given thanks, he broke it and said, \JesusWords{“This is my body which is for you. Do this in remembrance of me.”}}%
\verse{Likewise also the cup, after they had eaten, saying, \JesusWords{“This cup is the new covenant in my blood. Do this, as often as you drink it, in remembrance of me.”}}%
...
\verse{For the one who eats and drinks, if he\lebnote{“\textit{if}” is supplied as a component of the participle (“recognize”) which is understood as conditional} does not recognize the body, eats and drinks judgment against himself.}%
\verse{Because of this, many are weak and sick among you, and quite a few have died\lebnote{“have fallen asleep”}.}%
\verse{But if we were evaluating ourselves, we would not be judged.}%
\verse{But if we\lebnote{“\textit{if}” is supplied as a component of the participle (“are judged”) which is understood as conditional} are judged by the Lord, we are being disciplined, in order that we will not be condemned with the world.}%
\verse{So then, my brothers, when you\lebnote{“\textit{when}” is supplied as a component of the participle (“come together”) which is understood as temporal} come together in order to eat the Lord’s supper,\lebnote{*Here the direct object (“the Lord’s supper”) is supplied from context in the English translation} wait for one another.}%
...
\verseWithHeading{Varieties of Spiritual Gifts}{Now concerning spiritual gifts,\lebnote{Or “spiritual \textit{things}”; possibly “those who possess spiritual gifts”} brothers, I do not want you to be ignorant.}%
...
\verse{to another faith by the same Spirit, to another\lnDKZ{} gifts of healing by the one Spirit,}%
\verse{to another\lnDKZ{} miraculous powers\lebnote{“activities of power”}, to another\lnDKZ{} prophecy, to another\lnDKZ{} distinguishing of spirits, to another kinds of tongues, to another\lnDKZ{} interpretation of tongues.}%
\verse{But in all these things one and the same Spirit is at work, distributing to each one individually just as he wishes.}%
\verseWithHeading{Unity in the Midst of Diversity}{For just as the body is one and has many members, but all the members of the body, although they\lebnote{“\textit{although}” is supplied as a component of the participle (“are”) which is understood as concessive} are many, are one body, thus also Christ.}%
...
\verse{Now you are the body of Christ, and members of it individually\lebnote{“by part”},}%
...
\verse{Not all are apostles, are they?\lnDLA{} Not all are prophets, are they?\lnDLA{} Not all are teachers, are they?\lnDLA{} Not all are workers of miracles, are they?\lnDLA{}}%
\verse{Not all have gifts of healing, do they?\lnDLA{} Not all speak with tongues, do they?\lnDLA{} Not all interpret, do they?\lnDLA{}}%
...
\verse{it does not behave dishonorably, it is not selfish\lebnote{“does not seek the things of itself”}, it does not become angry, it does not keep a record of wrongs,}%
...
\verse{Love never fails. But if there are prophecies, they will pass away. If there are tongues, they will cease. If there is knowledge, it will pass away.}%
...
\verse{For now we see through a mirror indirectly\lebnote{“in an indirect image”}, but then face to face. Now I know in part, but then I will know completely, just as I have also been completely known.}%
...
\verse{For the one who speaks in a tongue does not speak to people but to God, because no one understands, but by the Spirit\lebnote{Or “in the Spirit”; or “in \textit{his} spirit”} he speaks mysteries.}%
...
\verse{Therefore what should I do\lnDLB{}? I will pray with my spirit, but I will also pray with my mind. I will sing praise with my spirit, but I will also sing praise with my mind.}%
...
\verse{In the law it is written: “By those who speak a foreign language and by the lips of others I will speak to this people, and not even in this way will they obey me,”\lebnote{from Isa 28:11–12} says the Lord.}%
...
\verse{the secret things of his heart become evident, and so, falling on his face, he will worship God, proclaiming, “God is truly among you!”}%
\verseWithHeading{Specific Instructions for Orderly Worship Services}{Therefore what should you do\lnDLB{}, brothers? Whenever you come together, each one of you has a psalm, has a teaching, has a revelation, has a tongue, has an interpretation. All things must be done for edification.}%
\verse{If anyone speaks in a tongue, it must be on one occasion two or at most three, and one after the other\lebnote{“in turn”}, and one must interpret.}%
...
\verse{For you are all able to prophesy in turn\lebnote{“one at a time}, in order that all may learn and all may be encouraged,}%
\verse{and the spirits of prophets are subject to prophets.}%
\verse{For God is not a God of disorder but of peace. As in all the churches of the saints,}%
...
\verse{Or has the word of God gone out from you, or has it come to you only?}%
...
\verse{For I passed on to you as of first importance\lebnote{“among the first \textit{things}”} what I also received, that Christ died for our sins according to the scriptures,}%
...
\verse{If we have put our hope\lebnote{“we are having put our hope”} in Christ in this life only, we are of all people most pitiable.}%
...
\verse{For “he subjected all things under his feet.”\lebnote{from Ps 8:6} But when it says “all things” are subjected, it is clear that the one who subjected all things to him is not included.}%
...
\verse{Do not be deceived! “Bad company corrupts good morals.”\lebnote{from the Greek poet Menander’s comedy \textit{Thais}, 218}}%
\verse{Sober up correctly and stop sinning\lebnote{“do not sin”}, for some have no knowledge of God — I say this to your shame.}%
...
\verse{Thus also it is written, “The first man, Adam, became a living soul”;\lebnote{from Gen 2:7} the last Adam became a life-giving spirit.}%
...
\verse{But whenever this perishable body puts on incorruptibility and this mortal body puts on immortality, then the saying that is written will take place: “Death is swallowed up in victory.}%
...
\verse{So then, my dear brothers, be steadfast, immovable, always abounding in the work of the Lord, because you\lebnote{“\textit{because}” is supplied as a component of the participle (“know”) which is understood as causal} know that your labor is not in vain in the Lord.}%
\end{biblechapter}%
...
\verse{On the first day of the week, each one of you put aside\lebnote{“put from himself”} something, saving up to whatever extent he has prospered\lebnote{“whatever if anything he has been prospered”}, in order that whenever I come, at that time collections do not take place.}%
