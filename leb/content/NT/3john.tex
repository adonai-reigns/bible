...
\verseWithHeading{Greeting} The elder, to Gaius the beloved, whom I love in \textit{the} truth.
...
\verseWithHeading{Instructions to Gaius} Dear friend, you act faithfully \textit{in} whatever you do for the brothers, \textit{even though they are strangers}.
...
\verseWithHeading{Diotrephes Causes Trouble} I wrote something to the church, but Diotrephes, who wants to be first \textit{among} them, does not acknowledge us.
...
\verseWithHeading{Demetrius Commended} Demetrius has been testified to by all, even by the truth itself. And we also testify \textit{to him}, and you know that our testimony is true.
